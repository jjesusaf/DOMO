    ...
    return (
        <div>
            ...
            <section className='home7'>
                ...
                <div className='home7-a'>
                    ...
                    <div className='home7-a2'>
                        ...
                        <img src={Image9} alt="" id='img9' />
                    </div>
                    <div className='home7-a3'>
                        LOGO
                    </div>
                    <div className='home7-a4'>
                        <img src={Image6} alt="" id='img6' />
                        <h2>
                            ¡Crece con nosotros!
                        </h2>
                    </div>
                    <div className='home7-a5'>
                        ...
                        <button className='btn2-registrer'>
                            Regístrate
                        </button>
                    </div>
                </div>
            ...
            <section className='home8'>
                ...
                <h2>
                    Conoce al equipo que impulsa este proyecto
                </h2>
                <div className='home8-c1'>
                    <div className='home8-a'>
                        <div className='home8-a1'>
                            <div className='home8-a1img'>
                                img
                            </div>
                            <div className='home8-a1text'>
                                <h1>
                                    Co_fundador
                                </h1>
                                <h2>
                                    Especialista en desarrollo y tecnología
                                </h2>
                            </div>
                        </div>
                        <div className='home8-a2'>
                            ...
                            <p>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi non tenetur a, modi molestiae totam nulla, praesentium corporis illum, magni itaque? Asperiores doloribus veniam iusto at saepe.
                            </p>
                        </div>
                    </div>
                    <div className='home8-a'>
